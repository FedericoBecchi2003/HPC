...
if (mpi_rank == 0) 
 printf("Ogni task riceve dati con MPI_scatter(). incrementa gli interi ricevuti e rispedisce con MPI_gather()\n"); 

for (i=0; i < LSIZE ; i++) *(localVector+i)+=1 ; // ogni task incrementa gli interi ricevuti
