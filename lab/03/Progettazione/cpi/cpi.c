...
{
    clock_gettime( CLOCK_REALTIME  , &ta); //////////////////////////////// prende tempo attuale e lo mette dentro ta
    ...
    h = 1.0 / (double) n; //ampiezza intervallo uniforme
...
//    sum= f1(n); 
   ...
   tnp = (double) ( tb.tv_sec  - ta.tv_sec )
       + (double) ( tb.tv_nsec - ta.tv_nsec )/ BILLION; // tempo non parallelo
