...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{cpi+amdahl.png}
  \caption{cpi+amdahl.png}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{heat_scaling.png}
  \caption{heat\_scaling.png}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{heatmap-animation-frame0.png}
